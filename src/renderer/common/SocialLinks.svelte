...
<div class="social-links">
    ...
    <a use:tooltip={{text: "GitHub"}} aria-label="Donate" class="social" id="github" target="_blank" href={githubUrl}>
    ...
    <a use:tooltip={{text: "Donate"}} aria-label="Github" class="social" id="donate" target="_blank" href={donateUrl}>
