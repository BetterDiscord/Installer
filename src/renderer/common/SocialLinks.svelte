...
<div class="social-links">
    <a class="social" id="web" title={$_("footer.social.website")} target="_blank" href={webUrl}>
    ...
    <a class="social" id="github" title={$_("footer.social.github")} target="_blank" href={githubUrl}>
    ...
    <a class="social" id="donate" title={$_("footer.social.support")} target="_blank" href={donateUrl}>
