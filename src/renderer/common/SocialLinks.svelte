<script>
    ...
    const licenseUrl = "https://github.com/rauenzi/BetterDiscordApp/blob/main/LICENSE";
</script>

<div class="social-links">
    <a class="social" id="web" title="Visit Website" target="_blank" href={webUrl}>
    ...
    <a class="social" id="license" title="MIT License" target="_blank" href={licenseUrl}>
